...
FULL_CFLAGS = $(BASE_FLAGS) $(CFLAGS) $(ADD_CFLAGS) $(DEFINES) $(WARNINGS) -MMD -MP -fvisibility=hidden
...
INSTALL_LIB_DIR = $(DESTDIR)/usr/lib/connman/plugins-vpn
